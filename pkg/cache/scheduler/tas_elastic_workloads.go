...
func (s *TASFlavorSnapshot) handleScaleUp(
	...
	deltaAssignments, reason := s.findTopologyAssignment(ctx, deltaRequest, placementLeader, assumedUsage, opts.committedDomainUsage, opts.simulateEmpty, "", opts.workload)
	if reason != "" {
